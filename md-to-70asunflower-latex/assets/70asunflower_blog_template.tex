...
\IfFontExistsTF{Noto Sans Mono CJK SC}{\setCJKmonofont{Noto Sans Mono CJK SC}}{\setCJKmonofont{FandolFang}}

% 数学字体：保持 LaTeX 默认数学字体（Latin Modern Math / Computer Modern 系），兼容性最好。
...
% Part 分隔卡片：适合长篇技术手册中的 Part/篇章标题
\newtcolorbox{partcard}[1][]{
  enhanced, breakable, colback=Primary!5, colframe=Primary, arc=3mm, boxrule=0pt,
  leftrule=5pt, left=18pt, right=18pt, top=14pt, bottom=14pt,
  shadow={1mm}{-1mm}{0mm}{black!10}, #1
}

% 面试常问框
\newtcolorbox{interviewbox}[1][]{
  enhanced, breakable, colback=Accent!5, colframe=Accent!30, arc=2mm, boxrule=0pt,
  borderline west={3pt}{0pt}{Accent}, fontupper=\small,
  fonttitle=\bfseries\color{Accent}, coltitle=Accent,
  attach boxed title to top left={yshift=-2mm, xshift=8mm},
  boxed title style={colback=Accent!5, arc=1mm, boxrule=0pt, left=8pt, right=8pt},
  title={$\star$ 面试常问}, #1
}

% 核心要点框
\newtcolorbox{keypointsbox}[1][]{
  enhanced, breakable, colback=TipBg, colframe=TipBg, arc=2mm, boxrule=0pt,
  borderline west={3pt}{0pt}{green!60!black}, fontupper=\small,
  fonttitle=\bfseries\color{green!40!black}, coltitle=green!40!black,
  attach boxed title to top left={yshift=-2mm, xshift=8mm},
  boxed title style={colback=TipBg, arc=1mm, boxrule=0pt, left=8pt, right=8pt},
  title={$\rightarrow$ 核心要点}, #1
}

% 术语/数据类型轻量高亮（谨慎使用，避免全文过度花哨）
\newcommand{\dtype}[1]{\texttt{\color{Primary}#1}}
\newcommand{\method}[1]{\textbf{\color{Accent}#1}}
